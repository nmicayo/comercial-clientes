...
|---|---|---|
| Lote piloto de 15–20 candidatos por perfil (30–40 no total) | ✅ (com nota) | Perfil A: 30 investigados (acima do range 15–20, mas dentro do espírito do critério). Perfil B: 20 investigados (dentro do range). Total: 50 (acima de 30–40, mas nenhum dos dois lotes ficou abaixo do mínimo). |
...
**Conclusão da verificação**: 5 dos 6 critérios estão plenamente satisfeitos. O critério de checagem Brevo está **parcialmente satisfeito** — totalmente cumprido para o Perfil A, mas bloqueado para o Perfil B por um problema de infraestrutura externo (allowlist de IP), não por omissão de processo. Recomendo que a aprovação final do rewrite condicione a esse ponto: rodar as 7 checagens Brevo pendentes assim que o bloqueio de IP for resolvido, antes de considerar os 12 qualificados do Perfil B como "prontos para campanha" de fato.
